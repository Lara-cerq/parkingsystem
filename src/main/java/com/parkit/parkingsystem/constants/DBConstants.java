...
public class DBConstants {
    ...
    public static final String COUNT_VEHICULEREG = "select t.VEHICLE_REG_NUMBER count(* ) as nbTimes from ticket t group by VEHICLE_REG_NUMBER where t.PARKING_NUMBER = ?";
}
